...
import uk.ac.tees.mad.carease.viewmodels.SelectServiceViewModelFactory
...
fun SelectServiceScreen(
    ...
    val viewModel: SelectServiceViewModel = viewModel(
        factory = SelectServiceViewModelFactory(container.selectServiceRepository)
    )
